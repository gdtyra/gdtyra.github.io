...
- [OpenMP](https://en.m.wikipedia.org/wiki/OpenMP)
- [OpenTK](https://en.wikipedia.org/wiki/OpenTK)
- [Avalonia](https://en.m.wikipedia.org/wiki/Avalonia_(software_framework))
- [Mono](https://en.m.wikipedia.org/wiki/Mono_(software))
- [CUDA](https://en.m.wikipedia.org/wiki/CUDA)
- [Google Web Toolkit](https://en.wikipedia.org/wiki/Google_Web_Toolkit)
- [libGDX](https://en.wikipedia.org/wiki/LibGDX)

### Web
- [Bootstrap](https://en.m.wikipedia.org/wiki/Bootstrap_(front-end_framework))
- [Tailwind CSS](https://en.m.wikipedia.org/wiki/Tailwind_CSS)
- [Prototype](https://en.m.wikipedia.org/wiki/Prototype_JavaScript_Framework)
- [Responsive web design](https://en.m.wikipedia.org/wiki/Responsive_web_design)
- [Holy grail layout](https://en.m.wikipedia.org/w/index.php?title=Holy_grail_(web_design)&wprov=rarw1)

### Languages
- [Ada](https://en.m.wikipedia.org/wiki/Ada_(programming_language))
...
- [Crystal](https://en.m.wikipedia.org/wiki/Crystal_(programming_language))
- [Common Lisp](https://en.wikipedia.org/wiki/Common_Lisp)
- [Embeddable Common Lisp](https://en.m.wikipedia.org/wiki/Embeddable_Common_Lisp)
- [Eiffel](https://en.m.wikipedia.org/wiki/Eiffel_(programming_language))
...
- [Verilog](https://en.m.wikipedia.org/wiki/Verilog)
- [Rust](https://en.wikipedia.org/wiki/Rust_(programming_language))
- [Raku](https://en.m.wikipedia.org/wiki/Raku_(programming_language))
- [Scala](https://en.wikipedia.org/wiki/Scala_(programming_language))
- [Scheme](https://en.wikipedia.org/wiki/Scheme_(programming_language))
- [Simula](https://en.m.wikipedia.org/wiki/Simula)
...
- [ALGOL](https://en.m.wikipedia.org/wiki/ALGOL)
- [JOVIAL](https://en.m.wikipedia.org/wiki/JOVIAL)
- [Self](https://en.m.wikipedia.org/w/index.php?title=Self_(programming_language)&wprov=rarw1)
- [Erlang](https://en.m.wikipedia.org/wiki/Erlang_(programming_language))
- [Holy C](https://en.m.wikipedia.org/wiki/TempleOS#Holy_C)
- [Zig](https://en.m.wikipedia.org/wiki/Zig_(programming_language))
- [Pony](https://www.ponylang.io/)
- [Pike](https://en.m.wikipedia.org/wiki/Pike_(programming_language))
- [Gambas](https://en.m.wikipedia.org/wiki/Gambas)
...
- [Monte Carlo tree search](https://en.m.wikipedia.org/wiki/Monte_Carlo_tree_search)
- [Tree traversal](https://en.m.wikipedia.org/wiki/Tree_traversal)
...
- [Scoreboarding](https://en.m.wikipedia.org/wiki/Scoreboarding)
...
- [Threaded binary tree](https://en.m.wikipedia.org/wiki/Threaded_binary_tree)
...
- [Skip list](https://en.m.wikipedia.org/wiki/Skip_list)
- [M-ary tree](https://en.m.wikipedia.org/wiki/M-ary_tree)
...
- [Fragile binary interface problem](https://en.m.wikipedia.org/wiki/Fragile_binary_interface_problem)
...
- [Multiple inheritance](https://en.m.wikipedia.org/wiki/Multiple_inheritance)
...
- [Sigil](https://en.m.wikipedia.org/wiki/Sigil_(computer_programming))
- [Stropping](https://en.m.wikipedia.org/wiki/Stropping_(syntax))
- [Corecursion](https://en.m.wikipedia.org/wiki/Corecursion)
- [Iterator pattern](https://en.m.wikipedia.org/wiki/Iterator_pattern)
- [Nondeterministic finite automaton](https://en.wikipedia.org/wiki/Nondeterministic_finite_automaton)
- [Stream processing](https://en.m.wikipedia.org/wiki/Stream_processing)
- [Compute kernel](https://en.m.wikipedia.org/wiki/Compute_kernel)
- [Sorting network](https://en.m.wikipedia.org/wiki/Sorting_network)
- [Gather/scatter](https://en.m.wikipedia.org/wiki/Gather/scatter_(vector_addressing)#Gather)
- [Array of Structs / Struct of Arrays](https://en.m.wikipedia.org/wiki/AoS_and_SoA)
- [Parallel array](https://en.m.wikipedia.org/wiki/Parallel_array)
- [Hamming weight](https://en.wikipedia.org/wiki/Hamming_weight)
- [Garbage collection](https://en.m.wikipedia.org/wiki/Garbage_collection_(computer_science)#Generational_GC_(aka_Ephemeral_GC))
- [Cache replacement policies](https://en.wikipedia.org/wiki/Cache_replacement_policies)
- [GRASP](https://en.m.wikipedia.org/wiki/GRASP_(object-oriented_design))
- [DevOps](https://en.m.wikipedia.org/wiki/DevOps)
- [Data-oriented design](https://en.m.wikipedia.org/wiki/Data-oriented_design)
- [Uniform function call syntax](https://en.m.wikipedia.org/wiki/Uniform_function_call_syntax)
- [Call stack](https://en.m.wikipedia.org/wiki/Call_stack)
- [Iteratee](https://en.m.wikipedia.org/wiki/Iteratee)
- [Closure](https://en.m.wikipedia.org/wiki/Closure_(computer_programming))
- [Actor model](https://en.m.wikipedia.org/wiki/Actor_model)
...
- [Cursor](https://en.m.wikipedia.org/wiki/Cursor_(databases))
...
- [Critical system](https://en.m.wikipedia.org/wiki/Critical_system)
- [Publish-subscribe](https://en.m.wikipedia.org/wiki/Publish%E2%80%93subscribe_pattern)
- [Service mesh](https://en.m.wikipedia.org/wiki/Service_mesh)
...
- [Feature toggle](https://en.m.wikipedia.org/wiki/Feature_toggle)
...
- [Unicode encodings](https://en.m.wikipedia.org/wiki/Comparison_of_Unicode_encodings)
- [ASCII](https://en.m.wikipedia.org/wiki/ASCII)
- [IBM PC compatible](https://en.m.wikipedia.org/wiki/IBM_PC_compatible)
- [Addressable cursor](https://en.m.wikipedia.org/wiki/Addressable_cursor)
...
- [OLE](https://en.m.wikipedia.org/wiki/Object_Linking_and_Embedding)
...
- [Microsoft-specific exception handling mechanisms](https://en.m.wikipedia.org/wiki/Microsoft-specific_exception_handling_mechanisms#SEH)
- [Windows Forms](https://en.m.wikipedia.org/wiki/Windows_Forms)
- [Windows Presentation Foundation](https://en.m.wikipedia.org/wiki/Windows_Presentation_Foundation)
- [Universal Windows Platform](https://en.m.wikipedia.org/wiki/Universal_Windows_Platform)
- [Windows Registry](https://en.m.wikipedia.org/wiki/Windows_Registry)
- [MSBuild](https://en.m.wikipedia.org/wiki/MSBuild)
- [Windows USER](https://en.m.wikipedia.org/wiki/Windows_USER)
- [Roaming user profile](https://en.m.wikipedia.org/wiki/Roaming_user_profile)
- [INI file](https://en.m.wikipedia.org/wiki/INI_file)
- [windows.h](https://en.m.wikipedia.org/wiki/Windows.h)
- [Active Template Library](https://en.m.wikipedia.org/wiki/Active_Template_Library)
- [WindowProc](https://en.m.wikipedia.org/wiki/WindowProc)
- [Managed code](https://en.m.wikipedia.org/wiki/Managed_code)
- [Windows Forms](https://en.m.wikipedia.org/wiki/Windows_Forms)
- [Visual Studio](https://en.m.wikipedia.org/wiki/Visual_Studio)
- [WinDbg](https://en.m.wikipedia.org/wiki/WinDbg)
...
- [AppImage](https://en.m.wikipedia.org/wiki/AppImage)
- [Line discipline](https://en.m.wikipedia.org/wiki/Line_discipline)
- [Everything is a file](https://en.m.wikipedia.org/wiki/Everything_is_a_file)
- [tput](https://en.m.wikipedia.org/wiki/Tput)
...
- [Universal 3D](https://en.m.wikipedia.org/wiki/Universal_3D)
...
- [Shadow mapping](https://en.m.wikipedia.org/wiki/Shadow_mapping)
- [Shadow volume](https://en.m.wikipedia.org/wiki/Shadow_volume)
- [Framebuffer object](https://en.m.wikipedia.org/wiki/Framebuffer_object#Uses)
...
- [Make](https://en.m.wikipedia.org/wiki/Make_(software)#Derivatives)
...
- [Marathon](https://en.wikipedia.org/wiki/Marathon_Trilogy)
- [Long file name](https://en.m.wikipedia.org/wiki/Long_filename)
- [Lattice C](https://en.m.wikipedia.org/wiki/Lattice_C)
...
- [React Native](https://en.m.wikipedia.org/wiki/React_Native)
- [Apache Cordova](https://en.m.wikipedia.org/wiki/Apache_Cordova)
- [Flutter](https://en.m.wikipedia.org/wiki/Flutter_(software))
...
- [coreboot](https://en.m.wikipedia.org/wiki/Coreboot)
- [Cube / AssaultCube / Saurbraten](https://en.m.wikipedia.org/wiki/Cube_(video_game))
